...
<div id="hLinks" class="w3-bar w3-indigo barLink">
        ...
        <a href="pageNotFound.php" class="w3-bar-item w3-button w3-hover-blue w3-mobile">Major projects</a>
        <a href="pageNotFound.php" class="w3-bar-item w3-button w3-hover-blue w3-mobile">Style experiments</a>
